...
This node uses an **API Key** (Bearer token). Obtain your key from the [Keupera dashboard](https://app.keupera.com).
...
[https://docs.keupera.com/api-reference/introduction](https://docs.keupera.com/api-reference/introduction)
